	...
	public class AcquaintanceDataSource : IDataSource<Acquaintance>
	{
		...
		static List<Acquaintance> GenerateAcquaintances()
		{
			return new List<Acquaintance>()
			{
				...
				new Acquaintance() { Id = "c227bfd2-c6f6-49b5-93ec-afef9eb18d08", FirstName = "Monica", LastName = "Green", Company = "Calcom Logistics", JobTitle = "Director", Email = "mgreen@calcomlogistics.com", Phone = "925-353-8029", Street = "230 3rd Ave", City = "San Francisco", PostalCode = "94118", State = "CA", PhotoUrl = "monicagreen.jpg" },
